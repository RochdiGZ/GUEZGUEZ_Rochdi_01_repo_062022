...
from common_modules import get_pages_urls_of_category, get_html_code_from


def save_page_images(page_url: str, home_url: str, relative_path: str):
...
def save_books_images(category_url: str, home_url: str):
    ...
    for page_url in category_pages_urls:
        save_page_images(page_url, home_url, relative_path)
